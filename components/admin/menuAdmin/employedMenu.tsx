...
import { createClient } from '@/lib/supabase/client'; // Cliente para componentes cliente
import { type User } from '@supabase/supabase-js';
import { logout } from '@/lib/actions/logOutAction'; // Importa a Server Action de logout
